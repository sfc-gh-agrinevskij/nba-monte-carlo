...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.nfl_random_num_gen
...
cross join
    NBA_MONTE_CARLO.PUBLIC.nfl_schedules as s
    -- LEFT JOIN NBA_MONTE_CARLO.PUBLIC.nfl_latest_results AS R ON R.game_id = S.game_id
