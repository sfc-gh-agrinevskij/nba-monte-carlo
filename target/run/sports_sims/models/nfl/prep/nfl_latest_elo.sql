  ...
  create or replace   view NBA_MONTE_CARLO.PUBLIC.nfl_latest_elo
   ...
   as (
    ...
    home_rating as (
        ...
        from NBA_MONTE_CARLO.PUBLIC.nfl_elo_rollforward
        group by all
    ),
    visiting_rating as (
        select
...
from final_rating f
inner join NBA_MONTE_CARLO.PUBLIC.nfl_raw_team_ratings o on f.team = o.team
  );
