...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.nfl_reg_season_end
...
left join NBA_MONTE_CARLO.PUBLIC.nfl_latest_elo le on le.team = mp.winning_team
    )
;
