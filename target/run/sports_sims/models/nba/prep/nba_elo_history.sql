...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.nba_elo_history
...
select a.*
from NBA_MONTE_CARLO.SEED.nba_elo a
union all
select
    l.game_date as date,
    2024 as season,
...
from NBA_MONTE_CARLO.PUBLIC.nba_elo_rollforward r
left join NBA_MONTE_CARLO.PUBLIC.nba_results_log l on r.game_id = l.game_id
    )
;
