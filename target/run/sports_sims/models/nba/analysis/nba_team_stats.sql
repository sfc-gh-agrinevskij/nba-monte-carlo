...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.nba_team_stats
...
with
    cte_games as (
        select
            ...
            t.team,
            t.season
        from NBA_MONTE_CARLO.PUBLIC.nba_elo_history h
        left join
            NBA_MONTE_CARLO.PUBLIC.nba_season_teams t
