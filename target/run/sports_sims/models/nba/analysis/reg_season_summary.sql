...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.reg_season_summary
...
with
    cte_summary as (
        ...
        from NBA_MONTE_CARLO.PUBLIC.reg_season_end e
        left join NBA_MONTE_CARLO.PUBLIC.nba_vegas_wins v on v.team = e.winning_team
        group by all
    )
...
from cte_summary c
left join NBA_MONTE_CARLO.PUBLIC.nba_reg_season_actuals a on a.team = c.team
    )
;
