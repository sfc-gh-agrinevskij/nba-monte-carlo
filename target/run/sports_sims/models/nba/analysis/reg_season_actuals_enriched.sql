...
create or replace transient table NBA_MONTE_CARLO.PUBLIC.reg_season_actuals_enriched
...
with
    ...
    cte_favored_wins as (
        ...
        from NBA_MONTE_CARLO.PUBLIC.nba_latest_results lr
        inner join
            NBA_MONTE_CARLO.PUBLIC.nba_results_log r
